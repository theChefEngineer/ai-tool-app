...
interface AppState {
  ...
  currentView: 'paraphrase' | 'summary' | 'translation' | 'grammar' | 'transcription' | 'ocr' | 'settings' | 'history' | 'chat' | 'plagiarism' | 'content-detector';
  toggleTheme: () => void;
  setMode: (mode: ParaphraseMode) => void;
  setSummaryMode: (mode: SummaryMode) => void;
  setCurrentView: (view: 'paraphrase' | 'summary' | 'translation' | 'grammar' | 'transcription' | 'ocr' | 'settings' | 'history' | 'chat' | 'plagiarism' | 'content-detector') => void;
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  setCurrentView: (view: 'paraphrase' | 'summary' | 'translation' | 'grammar' | 'transcription' | 'ocr' | 'settings' | 'history' | 'chat' | 'plagiarism' | 'content-detector') => set({ currentView: view }),
